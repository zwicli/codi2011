...
% \item Fijando el gravitino como la LSP del modelo, determinar los perfiles de background para electrones, positrones.
 % Elaborar los programas en \texttt{Pythia} para calculo del flujo de electrones, positrones.
% \item Participar activamente en la elaboración del artículo al respecto.
